...
ML_(generic_POST_sys_socket) ( ThreadId tid, SysRes res, UWord arg0, UWord arg1, UWord arg2 )
{
   ...
   if (datagrams && ((arg1 & 0xff) == 2))
   {
     ...
     fdsNode* node = VG_(HT_lookup)(fds, res.res);
     if (node == NULL)
     {
