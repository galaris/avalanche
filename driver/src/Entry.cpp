...
static void printHelpBanner()
{
	...
	"    --func-filter=<conds,	  enables separate function analysis\n"
	"    		    danger_ops,   use conds to filter condition QUERY's\n"
	"    		    all>	  use d_ops to filter dangerous operation QUERY's\n"
	...
	"    --input-filter-file=<name>	  the path to the file which contains input mask for input separate analysis\n"
        "\n"
