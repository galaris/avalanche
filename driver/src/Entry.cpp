...
static void printHelpBanner()
{
    char banner[] =
        ...
        "    --check-danger               enable emition of special constraints for memory\n"
	"                                 access operations and divisions (slows down the analysis)\n"
	...
	"    --mask=<mask_file>           specifies the file with a list of tainted data locations\n"
